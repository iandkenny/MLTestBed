	...
	<xsl:template match="/">
		<html>
			<body>
				...
				<br />
				<h2>Gas Spectrometary Experiment Result</h2>
				<hr />
				<p>
					<b>
						Key =
				...
				<p>
					<b>
						<xsl:if test="IterResult/ParticleNeighbourhood/*">
							Neighbourhood =
				...
				<table border="1">
					...
					<xsl:for-each select="IterResult/Output">
						<tr>
							...
							<!-- <xsl:if test="IterResult/Output/ResultVector"> <td> <xsl:value-of 
								select="ResultVector" /> </td> </xsl:if> -->
							<td>
				...
				<xsl:if test="IterResult/PredictionVector/*">
					<h4>Prediction Vector</h4>
					<table border="1">
						<xsl:for-each select="IterResult/PredictionVector">
							<tr>
								<xsl:for-each select="Cell">
