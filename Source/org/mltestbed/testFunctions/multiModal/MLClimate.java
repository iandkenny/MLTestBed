...
import org.mltestbed.data.readDB.ReadClimate;
import org.mltestbed.testFunctions.PsuedoSVM;
import org.mltestbed.util.Log;
import org.mltestbed.util.Particle;
import org.mltestbed.util.SimpleRegression;

public class MLClimate extends PsuedoSVM
{

	private static final String DATASET = "Dataset";
	private static ReadClimate db = null;
	...
	{
		super();
		description = "Machine Learning: Climate Model Data";
		info = "Predict if Climate Model fails";
		createParams();
	}
	/*
	 * (non-Javadoc)
...
//				sum += abs;
		...
		p.setFuncSpecific(
				"<?xml version=\"1.0\" encoding=\"ISO-8859-1\"?><?xml-stylesheet type=\"text/xsl\" href=\"climateresults.xsl\"?><IterResult><Key>"
						+ key + "</Key>" + toXML(),
				true);
		transBuf(p);
