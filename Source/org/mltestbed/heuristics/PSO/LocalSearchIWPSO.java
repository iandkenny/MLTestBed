 ...
 *         Window - Preferences - Java - Code Style - Code Templates
 */
public class LocalSearchIWPSO extends ClassicPSO
{
	private static final String DESCRIPTION = "Inertia Weight PSO with Cross Dimensional Local Search";
	 ...
	 * @param o
	 */
	public LocalSearchIWPSO(BaseSwarm o)
	{
		super(o);
		setDescription(DESCRIPTION);
	 ...
	 * 
	 */
	public LocalSearchIWPSO(Topology neighbourhood, Properties params,
