...
public class Emd
{
	...
	private static final String MINAS_PASSAGE_EDM_CSV = "MinasPassageEDM.csv";
	...
	{
		/*
		 * This code implements empirical mode decomposition in Java. Required
		 * parameters include: - order: the number of IMFs to return -
...
//		int order = 4;
		...
		EmdData emdData = emd.processEMD(order, array);
		k = 0;
		...
		File file = new File(MINAS_PASSAGE_EDM_CSV);
